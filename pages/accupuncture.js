...
const Accupuncture = () => {
    ...
    const bannerStyle= {
        backgroundImage: "url(https://braanaas.org/semester-assignment/wp-content/uploads/2021/09/accup_lg.jpg)",
        height: "32rem"
    }
    ...
    return (
        <div>
            <Head>
                <title>Accupuncture - Kunal Sharda</title>
            ...
            <TopNav/>
            <Banner assistiveText="Kunal holds a patient's hand while feeling their pulse with his fingers." banner={bannerStyle}  title="Accupuncture"/>
            <main>
